...
class FragmentDemoActivity : AppCompatActivity() {
    ...
    private val tag = "FragmentDemoActivity"
    
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_fragment_demo)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.fragmentDemo)) { v, insets ->
            val systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars())
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom)
            insets
        }
        
        title = "Fragment ViewPager Demo"
    ...
    private fun setupLogControlButtons() {
        ...
        findViewById<Button>(R.id.btnEnableAllLogs).setOnClickListener {
            ...
            LogManager.setTagEnabled("FragmentDemoActivity", true)
        ...
        findViewById<Button>(R.id.btnEnableFragmentLogs).setOnClickListener {
            LogManager.setLogEnabled(true)
            LogManager.setTagEnabled("FragmentDemoActivity", false)
            LogManager.setTagEnabled("FirstFragment", true)
