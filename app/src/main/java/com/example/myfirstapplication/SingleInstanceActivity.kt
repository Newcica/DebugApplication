...
class SingleInstanceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.singleInstance)) { v, insets ->
        ...
        Log.d("LaunchMode", "SingleInstanceActivity created, taskId: ${this.taskId}, hashCode: ${this.hashCode()}")
    }
    
    override fun onNewIntent(intent: Intent?) {
        super.onNewIntent(intent)
        Log.d("LaunchMode", "SingleInstanceActivity onNewIntent called")
    }
